...
class FeatureSelectionAnalyzer:
    def __init__(self, X, y, test_size=0.2, random_state=42, categorial_features=None):
        ...
        # missing_cats = set(self.categorial_features) - set(X.columns)
        # if missing_cats:
        #     raise ValueError(f"Категориальные признаки отсутствуют в данных: {missing_cats}")
